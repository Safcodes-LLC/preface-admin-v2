...
const PageForm = (props) => {
  ...
  const getListingPathWithFilters = () => {
    ...
    try {
      ...
      if (raw) {
        const { searchValue, selectedLanguage, selectedCategory, currentPage } =
          JSON.parse(raw);
    ...
    return `/admin/dashboards/cms/pages${search ? `?${search}` : ""}`;
  };
  ...
  const isRTLText = (text) => {
    ...
    console.log(
      "RTL Detection - Percentage:",
      totalChars > 0 ? ((rtlCount / totalChars) * 100).toFixed(2) + "%" : "0%"
    );
  ...
  const handleIndent = () => {
    ...
    message.success(
      `Indent applied: Level ${indentLevel} (${
  ...
  const handleOutdent = () => {
    ...
    const indentLevel = firstBlock.getData().get("indent-level");
    message.success(
      `Outdent applied: Level ${indentLevel} (${
        direction?.toUpperCase() || "LTR"
      })`
    );
  };
  ...
  const handleSimpleLinkClick = () => {
    ...
    const selectedText = blockWithSelection
      .getText()
  ...
  const handleEditLink = () => {
    ...
    if (!entityKey) {
      message.warning(
        "No link found at selection. Please select text with a link."
      );
      return;
    }
    ...
    const hasTooltip =
      entityData.tooltipContent && entityData.tooltipContent.trim() !== "";
      ...
      <div style={{ padding: "15px" }}>
        ...
        <div style={{ marginBottom: "15px" }}>
          ...
          <div style={{ fontSize: "12px", color: "#666", marginTop: "5px" }}>
            Enter full URL (https://...) or relative path (/page)
          </div>
        </div>
  ...
  const CustomLinkForm = ({
    ...
    const [showImageSection, setShowImageSection] = useState(
      initialData?.imageUrl ? true : false
    );
    ...
    const fetchPageData = async () => {
      if (mode === "EDIT" && param?.id) {
        try {
          ...
          // Handle content - check if it's HTML or JSON
                      ...
                      toolbarCustomButtons={[
                        ...
                        >
                          ...
                          >
                            ...
                            <Option
                              value="FONTWEIGHT_MEDIUM"
                              style={{ fontWeight: 500 }}
                            >
                              Medium (500)
                            </Option>
                            <Option
                              value="FONTWEIGHT_SEMIBOLD"
                              style={{ fontWeight: 600 }}
                            >
                              Semibold (600)
                            </Option>
                            <Option
                              value="FONTWEIGHT_BOLD"
                              style={{ fontWeight: 700 }}
                            >
                              Bold (700)
                            </Option>
                            <Option
                              value="FONTWEIGHT_EXTRABOLD"
                          ...
                          <Button
                            ...
                            type="default"
                            size="small"
                            style={{ borderColor: "#3e79f7", color: "#3e79f7" }}
                          ...
                          <Button
                            ...
                            type="default"
                            size="small"
                            style={{ borderColor: "#ff6b72", color: "#ff6b72" }}

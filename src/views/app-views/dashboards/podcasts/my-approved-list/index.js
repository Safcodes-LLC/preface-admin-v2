...
import { deletePost, fetchMyApprovedPost } from "store/slices/postSlice";
...
const ArticleList = () => {
  ...
  useEffect(() => {
    ...
    dispatch(fetchMyApprovedPost({ postTypeId: "66d9d564987787d3e3ff1313" }));
  }, [dispatch]);
    ...
    },
    {
      ...
      render: (_, record) => (
        <Button
          type="primary"
          onClick={() =>
            navigate(`/admin/dashboards/podcasts/view-podcast/${record._id}`)
          }
        >
          View Details
        </Button>

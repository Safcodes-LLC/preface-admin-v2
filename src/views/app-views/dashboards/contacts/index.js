...
const AuthorList = () => {
	...
	const [list, setList] = useState(AuthorListData)
	...
	const viewDetails = row => {
		navigate(`/admin/dashboards/authors/edit-author/${row.id}`)
	}
	...
	const handleShowCategory = value => {
		if(value !== 'All') {
			const key = 'category'
			const data = utils.filterArray(AuthorListData, key, value)
			setList(data)
		} else {
			setList(AuthorListData)
		}
	}
	...
	return (
		<Card>
			<Flex alignItems="center" justifyContent="space-between" mobileFlex={false}>
				...
				<div>
					<Button onClick={addAuthor} type="primary" icon={<PlusCircleOutlined />} block>Add Author</Button>
				</div>
			</Flex>
